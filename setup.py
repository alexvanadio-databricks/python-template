...
setup(
    ...
    description="Awesome python_template created by alexvanadio-databricks",
    url="https://github.com/alexvanadio-databricks/python-template/",
    long_description=read("README.md"),
    long_description_content_type="text/markdown",
    author="alexvanadio-databricks",
